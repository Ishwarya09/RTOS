...
int main(void)
{
  ...
  osThreadDef(Task1, Task_App, osPriorityNormal, 0, 128);
...
/* USER CODE BEGIN Header_Task_App */
/**
  * @brief  Function implementing the Task1 thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_Task_App */
void Task_App(void const * argument)
{
  /* USER CODE BEGIN 5 */
  /* Infinite loop */
...
void Task2_App(void const * argument)
{
  ...
  for(;;)
  {
      if (HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_0) == GPIO_PIN_SET) {
        HAL_GPIO_WritePin(GPIOC, GPIO_PIN_7, GPIO_PIN_RESET); // turn off LED
      } else {
        HAL_GPIO_WritePin(GPIOC, GPIO_PIN_7, GPIO_PIN_SET); // turn on LED
      }
      osDelay(100); // delay before checking the button again
    }
